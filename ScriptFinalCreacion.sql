...
CREATE TABLE BAN_PAGO_NOMINA(
    ...
    CONSTRAINT FK_PGN_CTA_NUMERO FOREIGN KEY (PGN_CTA_NUMERO) REFERENCES BAN_CUENTA(CTA_NUMERO),
...
CREATE TABLE BAN_ESTADO_C (
    ...
    CONSTRAINT FK_CTA_NUMERO_BAN_ESTADO_C FOREIGN KEY (ESC_CTA_NUMERO) REFERENCES BAN_CUENTA (CTA_NUMERO)
);
...
CREATE TABLE BAN_CONCILIACION (
    ...
    CON_MES VARCHAR2(30),
    CON_LAX_AUX_LLAVE,
    CON_ESF_ESTADO_F_LLAVE,
    CON_LAX_SALDO NUMERIC(18,2),
    CON_ESF_SALDO NUMERIC(18,2),
    ...
    CONSTRAINT FK_LAX_SALDO_CONCILIACION FOREIGN KEY (CON_LAX_AUX_LLAVE) REFERENCES BAN_LIBRO_AUX(LAX_LIBRO_AUX),
    CONSTRAINT FK_ESF_SALDO_CONCILIACION FOREIGN KEY (CON_ESF_ESTADO_F_LLAVE) REFERENCES BAN_ESTADO_FINANCIERO(ESF_ESTADO_FINANCIERO)
);

CREATE TABLE BAN_DEPOSITO (
    DEP_DEPOSITO NUMERIC GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL,
    DEP_BANCO NUMERIC,
    DEP_CUENTA VARCHAR2(30),
