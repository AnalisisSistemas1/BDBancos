...
DROP TABLE IF EXISTS BAN_NOTAS_CD;
DROP TABLE IF EXISTS BAN_COMPRA_E;
DROP TABLE IF EXISTS BAN_CHEQUE;
DROP TABLE IF EXISTS BAN_PAGO_NOMINA;
DROP TABLE IF EXISTS BAN_TRANSFERENCIA;
DROP TABLE IF EXISTS BAN_P_SERVICIO;
DROP TABLE IF EXISTS BAN_PROVEEDOR_FACTURA;
...
DROP TABLE IF EXISTS BAN_DEPOSITO;
DROP TABLE IF EXISTS BAN_CUENTA;
DROP TABLE IF EXISTS BAN_PROVEEDOR;
DROP TABLE IF EXISTS BAN_FACTURA;
