...
INSERT INTO BAN_CONCILIACION (CON_BANCO, CON_MES, CON_LAX_SALDO, CON_ESF_SALDO, CON_DIFERENCIA, CON_ESTADO)
VALUES (
    (SELECT BCO_BANCO FROM BAN_BANCO WHERE BCO_NOMBRE = 'BANCO INDUSTRIAL, S.A.' AND ROWNUM = 1),
    'Marzo 2024',
    (SELECT LAX_LIBRO_AUX FROM BAN_LIBRO_AUX WHERE LAX_FACTURA = 'FACT-001' AND ROWNUM = 1),
    (SELECT ESF_ESTADO_FINANCIERO FROM BAN_ESTADO_FINANCIERO WHERE ESF_TRANSACCION = 1 AND ROWNUM = 1),
    500.00, 
    'Pendiente'
);
...
VALUES (
    ...
    'Marzo 2024',
    (SELECT LAX_LIBRO_AUX FROM BAN_LIBRO_AUX WHERE LAX_FACTURA = 'FACT-002' AND ROWNUM = 1),
    (SELECT ESF_ESTADO_FINANCIERO FROM BAN_ESTADO_FINANCIERO WHERE ESF_TRANSACCION = 2 AND ROWNUM = 1),
    -500.00,
    'Pendiente'
);
...
INSERT INTO BAN_CONCILIACION (CON_BANCO, CON_MES, CON_LAX_SALDO, CON_ESF_SALDO, CON_DIFERENCIA, CON_ESTADO)
VALUES (
    (SELECT BCO_BANCO FROM BAN_BANCO WHERE BCO_NOMBRE = 'BANCO AGROMERCANTIL DE GUATEMALA' AND ROWNUM = 1),
    'Marzo 2024',
    (SELECT LAX_LIBRO_AUX FROM BAN_LIBRO_AUX WHERE LAX_FACTURA = 'FACT-003' AND ROWNUM = 1),
    (SELECT ESF_ESTADO_FINANCIERO FROM BAN_ESTADO_FINANCIERO WHERE ESF_TRANSACCION = 3 AND ROWNUM = 1),
    0,
    'Pendiente' 
);
...
INSERT INTO BAN_CONCILIACION (CON_BANCO, CON_MES, CON_LAX_SALDO, CON_ESF_SALDO, CON_DIFERENCIA, CON_ESTADO)
VALUES (
    (SELECT BCO_BANCO FROM BAN_BANCO WHERE BCO_NOMBRE = 'BANK OF AMERICA, NOS ACCOUNT' AND ROWNUM = 1),
    'Marzo 2024',
    (SELECT LAX_LIBRO_AUX FROM BAN_LIBRO_AUX WHERE LAX_FACTURA = 'FACT-003' AND ROWNUM = 1),
    (SELECT ESF_ESTADO_FINANCIERO FROM BAN_ESTADO_FINANCIERO WHERE ESF_TRANSACCION = 4 AND ROWNUM = 1),
    0, 
    'Pendiente' 
);