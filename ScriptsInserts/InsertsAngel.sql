...
VALUES ('Departamento de Finanzas', 'Juan P�rez', 'juan.perez@gmail.com');
...
SELECT DEP_DEPARTAMENTO, 'Ana', 'Gonz�lez', '1234567890123', TO_DATE('1995-10-20', 'YYYY-MM-DD'), 'Analista Financiero'
FROM BAN_DEPARTAMENTO
WHERE DEP_NOMBRE = 'Departamento de Finanzas'
AND ROWNUM = 1;

INSERT INTO BAN_EMPLEADO (DEP_DEPARTAMENTO, EMP_NOMBRES, EMP_APELLIDOS, EMP_DPI, EMP_FECHA_NAC, EMP_PUESTO)
SELECT DEP_DEPARTAMENTO, 'Pedro', 'Mart�nez', '9876543210987', TO_DATE('1990-08-15', 'YYYY-MM-DD'), 'Coordinador de Log�stica'
FROM BAN_DEPARTAMENTO
WHERE DEP_NOMBRE = 'Departamento de Logisitca'
AND ROWNUM = 1;

INSERT INTO BAN_EMPLEADO (DEP_DEPARTAMENTO, EMP_NOMBRES, EMP_APELLIDOS, EMP_DPI, EMP_FECHA_NAC, EMP_PUESTO)
SELECT DEP_DEPARTAMENTO, 'Mar�a', 'L�pez', '4567890123456', TO_DATE('1988-12-10', 'YYYY-MM-DD'), 'Ejecutivo de Ventas'
FROM BAN_DEPARTAMENTO
WHERE DEP_NOMBRE = 'Departamento de Marketing/Ventas'
AND ROWNUM = 1;

INSERT INTO BAN_EMPLEADO (DEP_DEPARTAMENTO, EMP_NOMBRES, EMP_APELLIDOS, EMP_DPI, EMP_FECHA_NAC, EMP_PUESTO)
SELECT DEP_DEPARTAMENTO, 'Juan', 'G�mez', '7890123456789', TO_DATE('1992-04-25', 'YYYY-MM-DD'), 'Contador'
FROM BAN_DEPARTAMENTO
